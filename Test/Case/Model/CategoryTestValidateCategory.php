...
/**
 * Expect Category validation error by notEmpty error on create
 *
 * @return void
 */
	public function testCategoryErrorByNotEmptyOnCreate() {
		//Checkカラム
		$fields = array(
			'block_id' => __d('net_commons', 'Invalid request.'),
			//'key' => __d('net_commons', 'Invalid request.'),
			'name' => sprintf(__d('net_commons', 'Please input %s.'), __d('categories', 'Category')),
		);
		//Check項目
		$checks = array(
			null, '', false,
...
/**
 * Expect Category validation error by notEmpty error on update
 *
 * @return void
 */
	public function testCategoryErrorByNotEmptyOnUpdate() {
		//Checkカラム
		$fields = array(
			'block_id' => __d('net_commons', 'Invalid request.'),
			'key' => __d('net_commons', 'Invalid request.'),
...
/**
 * Expect CategoryOrder validation error by notEmpty error on create
 *
 * @return void
 */
	public function testCategoryOrderErrorByNotEmptyOnCreate() {
		//Checkカラム
		$fields = array(
			'block_key' => __d('net_commons', 'Invalid request.'),
			//'category_key' => __d('net_commons', 'Invalid request.'),
		);
		//Check項目
		$checks = array(
			null, '', false,
...
/**
 * Expect CategoryOrder validation error by notEmpty error on update
 *
 * @return void
 */
	public function testCategoryOrderErrorByNotEmptyOnUpdate() {
		//Checkカラム
		$fields = array(
			'block_key' => __d('net_commons', 'Invalid request.'),
			'category_key' => __d('net_commons', 'Invalid request.'),
...
/**
 * Expect number error of CategoryOrder model
 * Expect CategoryOrder validation error by notEmpty error on create
 *
 * @return void
 */
	public function testCategoryOrderErrorByNumber() {
		//Checkカラム
		$fields = array(
			'weight' => __d('net_commons', 'Invalid request.'),
		);
		//Check項目
		$checks = array(
